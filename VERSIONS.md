...
| RS_Pedidos.js | 1.3 | ACCESORIOS: aplica descuento reseller (* 0.60) al PVP de ACCESORIOS igual que _buildPriceMap |
| RS_Email.js | 1.0 | |
| RS_Main.js | 1.0 | |
| RS_OTs.js | 1.0 | |
| RS_Auth.js | 1.0 | |
...
| Despacho_Index.html | 2.3 | Seriales: N inputs individuales por unidad, contador X/Y, sincroniza con cantidad |

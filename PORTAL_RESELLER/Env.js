...
var SCHEMA = {
  SHEETS: {
    ...
    PLANTILLAS_COTIZADOR: 'PLANTILLAS_COTIZADOR',
    KITS_PEDIDOS: 'KITS_PEDIDOS',
    KITS:               'KITS',
    NOVEDADES:          'NOVEDADES',
    EVENTOS:               'EVENTOS',
    INSCRIPCIONES_EVENTOS: 'INSCRIPCIONES_EVENTOS',
    VIDEOS_MODELOS:        'VIDEOS_ARMADO_DESARMADO',
    CURSOS_MATERIAL:       'CURSOS_MATERIAL',
    REPUESTOS_RECOMENDADOS: 'REPUESTOS_RECOMENDADOS_DJI',
    MANTENIMIENTO_DJI:      'MANTENIMIENTO_DJI',
    COMPRAS_DETALLE:       'COMPRAS_DETALLE',
    RESERVAS_EN_CAMINO:    'RESERVAS_EN_CAMINO',
    CONFIG_PROSPECTOS:     'CONFIG_PROSPECTOS',
    SOLICITUDES_RESELLER:  'SOLICITUDES_RESELLER',
